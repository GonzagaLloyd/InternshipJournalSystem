...
<template>
    ...
    <div class="text-[#C9B79C] py-8 md:py-12 lg:py-16 px-4 sm:px-6 lg:px-8 flex flex-col items-center relative font-serif min-h-screen bg-[#1B1B1B]">
        ...
        <div :class="[
            'sticky top-0 w-full z-40 transition-[padding,background-color,border-color,box-shadow,backdrop-filter] duration-500 ease-in-out flex justify-center px-4 sm:px-6 will-change-[padding,background-color]',
            isScrolled 
            ...
            <div :class="['w-full max-w-4xl flex items-center justify-between gap-4 transition-[max-width] duration-500 ease-in-out', isScrolled ? 'md:max-w-5xl' : '']">
                <!-- Return Link -->
