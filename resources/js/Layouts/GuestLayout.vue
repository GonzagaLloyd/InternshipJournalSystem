...
const backgrounds = [
    ...
    'https://images.unsplash.com/photo-1550684848-fac1c5b4e853?q=80&w=2070&auto=format&fit=crop', // Repeat to ensure first feels smooth
...
<template>
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-[#020617] overflow-hidden relative font-sans">
        ...
        <div class="absolute inset-0 z-0 overflow-hidden bg-[#020617]">
            ...
            <div class="absolute inset-0 bg-[#020617]/80 backdrop-blur-[2px]"></div>
        </div>

        <div class="relative z-10 mb-8 drop-shadow-[0_20px_20px_rgba(0,0,0,0.4)] transition-all duration-700 hover:scale-105">
            <Link href="/">
                <ApplicationLogo class="h-64 fill-current text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.3)] transition-all hover:drop-shadow-[0_0_25px_rgba(255,255,255,0.5)]" />
            </Link>
        </div>

        <div
            class="relative z-10 w-full sm:max-w-md mt-4 px-10 py-12 bg-white/5 backdrop-blur-2xl overflow-hidden sm:rounded-3xl border border-white/10 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] transition-all duration-500 hover:border-white/20"
        >
            <slot />
        </div>
    </div>
